...
export const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-full h-full sm:h-[400px] md:w-[820px] lg:min-h-full sm:flex sm:justify-center object-contain"
      ...
      >
        <Image
          ...
          width={420}
          height={304}
          className="w-full max-w-[520px] md:max-w-[650px] h-full rounded-lg  aspect-auto"
        />
      </motion.div>
